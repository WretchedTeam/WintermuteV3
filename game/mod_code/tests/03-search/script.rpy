...
label script3_m():
    ...
    show monika ma
    call test_prompt_button("Ask Monika a search query") from _call_test_prompt_button_152
    ...
    show monika ma
    call test_prompt_button("Respond") from _call_test_prompt_button_153
...
label script3_s():
    ...
    s lup "What's up?"
    show sayori ma
    call test_prompt_button("Ask Sayori a search query") from _call_test_prompt_button_155
...
label script3_n():
    ...
    n mh "Yo."
    show natsuki ma
    call test_prompt_button("Ask Natsuki a search query") from _call_test_prompt_button_157
    ...
    show natsuki md
    call test_prompt_button("Respond") from _call_test_prompt_button_158
