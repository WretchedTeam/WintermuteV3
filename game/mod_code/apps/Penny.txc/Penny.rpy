...
screen penny_idle():
    ...
    button:
        ...
        add "penny neutral" zoom 0.8 at _wm_shadow.DropShadow(yoff=32.0, blur=8.0, color="#1116")
    ...
    if t:
        button:
            ...
            hbox:
                ...
                add penny_img zoom 0.8 at _wm_shadow.DropShadow(yoff=32.0, blur=8.0, color="#1116")
