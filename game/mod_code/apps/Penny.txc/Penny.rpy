...
screen penny_idle():
    ...
    button:
        ...
        add "penny neutral" zoom 0.8 at _wm_shadow.DropShadow(yoff=2.0, blur_r=10.0, color="#2222")
    ...
    if t:
        button:
            ...
            hbox:
                ...
                add penny_img zoom 0.8 at _wm_shadow.DropShadow(yoff=2.0, blur_r=10.0, color="#2222")
