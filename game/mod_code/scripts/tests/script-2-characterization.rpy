...
label characterization_qa(doki):
    ...
    while len(menu_set) < 5:
        menu:
            ...
            "Likes?":
                call expression "characterization_" + doki + "_likes"
            "Dislikes?":
                call expression "characterization_" + doki + "_dislikes"
            "Favourite media?":
                call expression "characterization_" + doki + "_media"
            "Your ideal day?":
                call expression "characterization_" + doki + "_ideal_day"
            "Attractions?":
                call expression "characterization_" + doki + "_attractions"

    $ del menu_set
    return

label characterization_monika_likes():
    mc "What do you like?"
    m "Oh! Well…"
...
label characterization_monika_dislikes():
...
label characterization_monika_media():
...
label characterization_monika_ideal_day():
...
label characterization_monika_attractions():
...
label characterization_monika():
    ...
    call characterization_qa("monika")
...
label characterization_sayori_dislikes():
    mc "What do you dislike?"
    s "That’s not fair!"
...
label characterization_sayori_media():
...
label characterization_sayori_ideal_day():
    mc "What is your ideal day?"
...
label characterization_sayori_attractions():
    mc "What are some traits you consider attractive?"
    s "Uh...ehehe~"
...
label characterization_sayori():
    ...
    call characterization_qa("sayori")
...
label characterization_natsuki_dislikes():
    mc "What do you dislike?"
    n "You."
...
label characterization_natsuki_media():
    mc "What’s your favourite piece of media?"
...
label characterization_natsuki_ideal_day():
    mc "What is your ideal day?"
    n "My ideal day?"
...
label characterization_natsuki_attractions():
    mc "What are some traits you consider attractive?"
    n "..."
...
label characterization_natsuki():
    # Address Natsuki
    mc "Hello, Natsuki."
    n "Yo."
    n "‘Sup?"
    ...
    # Your ideal day?
    # Attractions?
    call characterization_qa("natsuki")
...
label characterization_yuri_dislikes():
    mc "What do you dislike?"
    y "D-dislike…?"
...
label characterization_yuri_media():
    mc "What’s your favourite piece of media?"
    y "My favorite…?"
...
label characterization_yuri_ideal_day():
    mc "What is your ideal day?"
    y "My ideal day?"
...
label characterization_yuri_attractions():
    mc "What are some traits you consider attractive?"
