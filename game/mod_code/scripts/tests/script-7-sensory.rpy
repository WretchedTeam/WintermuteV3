...
label sensory_s:
    ...
    s "Wh-why did you do that, [firstname]?"
...
label sensory_y:
    ...
    y "Why do I feel like this, [firstname]?"
    show yuri e6
    y "What happened to me?"
    show yuri m2
    show yuri shy wmflicker at t11
    pause(4.0)
    $yref()
