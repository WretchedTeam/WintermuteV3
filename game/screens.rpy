...
style slider:
    ...
    base_bar Frame("mod_assets/gui/slider/horizontal_[prefix_]bar.png", gui.slider_borders, tile=gui.slider_tile)
    thumb "mod_assets/gui/slider/horizontal_[prefix_]thumb.png"
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("AI Selection") action Jump("ai_selection")
            textbutton _("Desktop") action Jump("go_to_desktop")
